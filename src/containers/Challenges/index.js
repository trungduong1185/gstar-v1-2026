  ...
  return (
    <>
      ...
      <div className="dn db-l w-100 bg-pc-red mb6">
        <div className="w-container  center pv5">
          ...
          <div className="_mansory w-100 flex flex-wrap justify-between  relative">
            ...
            <div className="w-40 ph3">
              <div className="w-100 pv5">
                <p className="f4 fw7 pc-white ttu tracked lh-copy">
                  {challenges.col_4.title}
                </p>
                <p className="pc-pink-white mt4 tracked lh-copy f6 poppins fw2">
                  {challenges.col_4.content}
                </p>
              </div>
              ...
              <img
                ...
                alt=""
                className="absolute"
                style={{ width: '40%', top: '202px', right: '3%' }}
              />
            </div>
          </div>
        </div>
      ...
      <div class="db dn-l w-100 bg-pc-red pt5 pb4 block-pt-pb">
